# Chapter 08d: Dependent Types (Typed Patterns)

This stage introduces **typed pattern matching and constructors** for a small indexed family (Vec). Branch types must be non-dependent; truly dependent pattern matching is deferred to the full stage.
