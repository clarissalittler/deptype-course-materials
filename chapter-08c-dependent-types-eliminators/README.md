# Chapter 08c: Dependent Types (Sound Eliminators)

This stage adds **sound eliminators** for Nat/Bool/Unit/Empty and J on top of the bidirectional core. Pattern matching and inductive families remain restricted.
