...
This stage is a **toy dependent type checker** meant to introduce the syntax and core ideas. It is intentionally permissive and not fully sound. Later stages tighten the rules and add proper normalization and universe discipline.
